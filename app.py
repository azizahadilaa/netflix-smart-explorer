...
st.markdown("""
    ...
    .movie-card {
        ...
        border-left: 5px solid #E50914; margin-bottom: 20px; height: 250px;
    }
    .movie-title { color: #E50914; font-weight: bold; font-size: 18px; }
    </style>
            ...
            with cols[i]:
                st.markdown(f"""
                    <div class="movie-card">
                        ...
                        <p style="font-size:12px;"><b>{item['release_year']}</b> | {item['rating']}</p>
                        <p style="font-size:11px;">{item['description'][:120]}...</p>
                    </div>
                """, unsafe_allow_html=True)
